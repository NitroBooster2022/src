...
class EncoderNode():
    def __init__(self):
        ...
        self.link_sub = rospy.Subscriber("/gazebo/link_states", LinkStates, self.link_callback, queue_size=3)
    ...
    def publish_steering_angle(self):
        ...
        if steering_angle > 90:
            ...
            steering_angle += 180
        print("real steering angle: ", round(steering_angle, 2), ", command: ", round(self.steer, 2), ", error: ", round(steering_angle - self.steer, 2))
